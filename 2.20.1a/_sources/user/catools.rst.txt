...
The table below enumerates the possibilities:
    ...
    =============================== ====================== ========================================
    :class:`~cothread.dbr.ca_str`   :class:`str`           String value
    :class:`~cothread.dbr.ca_int`   :class:`int`           Integral value
    :class:`~cothread.dbr.ca_float` :class:`float`         Floating point value
    :class:`~cothread.dbr.ca_array` :class:`numpy.ndarray` Any array value
    =============================== ====================== ========================================

..  class:: cothread.dbr.ca_str

    Scalar type derived from basic Python type.
